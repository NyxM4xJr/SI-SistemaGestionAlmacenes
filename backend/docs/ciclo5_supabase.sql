...
CREATE TABLE IF NOT EXISTS venta (
    ...
    metodo_pago  TEXT          NOT NULL DEFAULT 'pendiente',  -- pendiente|efectivo|stripe|paypal
    estado       TEXT          NOT NULL DEFAULT 'registrada', -- registrada|pagada|anulada
    pago_id      BIGINT,       -- FK opcional a pagos_sistema (si aplica)
...
CREATE TABLE IF NOT EXISTS detalle_venta (
    ...
    plato_id        BIGINT NOT NULL REFERENCES plato(id),
